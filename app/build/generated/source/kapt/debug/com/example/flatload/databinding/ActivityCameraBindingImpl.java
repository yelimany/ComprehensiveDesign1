...
public class ActivityCameraBindingImpl extends ActivityCameraBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.button_camera, 4);
        sViewsWithIds.put(R.id.button_gallery, 5);
        sViewsWithIds.put(R.id.textView17, 6);
        sViewsWithIds.put(R.id.editText_type, 7);
        sViewsWithIds.put(R.id.textView18, 8);
        sViewsWithIds.put(R.id.editText_photo_location, 9);
        sViewsWithIds.put(R.id.button_now_location, 10);
        sViewsWithIds.put(R.id.button_metadata_location, 11);
        sViewsWithIds.put(R.id.button_done, 12);
